        ...
        <div className='flex flex-col '>
          <h4 className='font-epilogue font-semibold text-[14px] text-[#b2b3bd]
            ...
            <p className='mt-[3px] font-epilogue font-normal text-[12px]
             leadin-[18px] text-[#808191] sm:max-w-[120px] truncate'>Raised of {target}</p>
          </h4>
        </div>
        <div className='flex flex-col '>
          <h4 className='font-epilogue font-semibold text-[14px] text-[#b2b3bd]
            ...
            {remainingDays}
            <p className='mt-[3px] font-epilogue font-normal text-[12px]
             leadin-[18px] text-[#808191] sm:max-w-[120px] truncate'>Days Left</p>
          </h4>
        </div>
        </div>
